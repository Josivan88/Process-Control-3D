...
////// Specular:
                ...
                float3 diffuseColor = (_MainTex_var.rgb*lerp(_Color_var.rgb,node_5904,(node_3795*_Selected_var))); // Need this for specular when using metallic
